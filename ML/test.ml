...
let eval_checkval = [
  ...
  ("let x = 2 in let y = x in y + y", V_int(4));
  ("let x = 2 in let y = x in x + x", V_int(4));
  ("let x = 2 in let y = x + 1 in y + x", V_int(5));
  ...
  ("class C {mut a : int}; let c = 1 in let x = C(capof(c),c) in x.a = x.a + 1; x.a", V_int(2));
  ("let x = 1 in let y = 0 in branch x {x}; y", V_int(0));
  ("class C {mut a : int}; let c = 1 in let x = C(capof(c),c) in while (x.a > 0) {x.a = x.a - 1}; x.a", V_int(0));
  ("class C {mut a : int}; let c = 3 in let x = C(capof(c),c) in while (x.a > 0) {x.a = x.a - 1}; x.a", V_int(0));
  ("class C {mut a : int}; let c = 3 in let c2 = 0 in let x = C(capof(c), c) in let x2 = C(capof(c2),c2) in while (x.a > 0) {x.a = x.a - 1; x2.a = x2.a + 2}; x2.a", V_int(6));
  ("class C {mut a : bool}; let c = false in let x = C(capof(c), c) in let c2 = false in let y = C(capof(c2), c2) in while (x.a) {y.a = true}; y.a", V_bool(false));
  ...
  ("let a = 1 in let f = fun (a | x : a int)->int { 10 } in f(capof(a),a); a", V_int(1));
  ...
  ("let a = 1 in let f = fun (a | x : a int)->int { let x2 = 0 in x2 } in f(capof(a),a)", V_int(0));
  ("let a = 1 in let f = fun (a | x : a int)->int { let x2 = 0 in x2 } in f(capof(a),a); a", V_int(1));
  ("let a = 1 in let f = fun (a | x : a int)->int { let x2 = 0 in x2 } in let b = f(capof(a),a) in b", V_int(0));
  ...
  ("class C {mut a : int}; let c = 1 in let x = C(capof(c),c) in let y = x in (y.a = 0; y.a)", V_int(0));
  (* immutable object does not consume *)
  ("class C {a : int}; let c = 1 in let x = C(capof(c),c) in let y = x in y.a", V_int(1));
  ("class C {a : int}; let c = 1 in let x = C(capof(c),c) in let y = x in x.a", V_int(1));
  ...
  ("class C {a : int}; let c = 2 in let x = C(capof(c), c) in let f = fun (x | z : x int)->int { let z2 = z + 1 in z2 } in f(capof(x),x.a)", V_int(3));
  ("class C {a : int}; let c = 2 in let x = C(capof(c), c) in let f = fun (x | z : x int)->int { let z2 = z + 1 in z2 } in f(capof(x),x.a); x.a", V_int(2));
  ("class C {a : int}; let c = 2 in let x = C(capof(c), c) in let f = fun (x | z : x int)->int { let z2 = z + 1 in z2 } in f(capof(x),x.a)", V_int(3));
  ("class C {a : int}; let c = 2 in let x = C(capof(c), c) in let f = fun (x | z : x int)->int { let z2 = z + 1 in z2 } in f(capof(x),x.a); x.a", V_int(2));
  ("class C {a : int}; let c = 2 in let x = C(capof(c), c) in let f = fun (x | z : x int)->int { let z2 = z + 1 in z2 } in f(capof(x),x.a); x.a", V_int(2));
  ("class C {mut a : int}", V_unit);
  ("class C {mut U a : int}", V_unit);
  ("class C {mut a : int}; let c = 1 in let x = C(capof(c), c) in let f = fun (c | a : c int)->int { x.a } in x.a = 2; f(capof(c),c)", V_int(2));
  ("class C {mut a : int}; let c = 1 in let x = C(capof(c), c) in x.a", V_int(1));
  ("class C {mut a : int}; let c = 1 in let x = C(capof(c), c) in x.a = 5; x.a", V_int(5));
  ...
  ("class C {mut a : int}; class C2 {mut o : C};let c = 1 in let x = C(capof(c), c) in let y = C2(capof(x), x) in y.o.a = 0; y.o.a", V_int(0));
  ("class C {mut a : int}; class C2 {o : C};let c = 1 in let x = C(capof(c), c) in let y = C2(capof(x), x) in y.o.a = 0; y.o.a", V_int(0));
  (* TODO - destroying x.a and x are the same? *)
  ("class C {mut a : int}; let c = 1 in let x = C(capof(c), c) in destroy(x.a); x.a = 3; let y = x.a in y", V_int(3));
  ("class C {mut a : int}; let c = 1 in let x = C(capof(c), c) in destroy(x); x.a = 3; let y = x.a in y", V_int(3));
  ...
  ("class C {mut U a : int, mut U b : int}; let c = 1 in let d = 2 in let x = C(capof(c), capof(d), c, d) in focus x { destroy(x.a); let y = x.b in y }", V_int(2));
  ("class C {mut U a : int}; let c = 1 in let x = C(capof(c), c) in focus x { destroy(x.a); x.a = 5 }; let y = x.a in y", V_int(5));
  ("class C { 
  ...
  ("class C {a : int}; class C2 {mut a : int}; let c1 = 0 in let x = C(capof(c1), c1) in let c2 = x.a in let y = C2(capof(c2), c2) in y.a", V_int(0));
  ("class C {a : int}; class C2 {mut a : int}; let c1 = 0 in let x = C(capof(c1), c1) in let c2 = x.a in let y = C2(capof(c2), c2) in x.a", V_int(0));
]
...
let eval_success = [
  ...
  "class C {mut a : int}; class C2 {mut o : C}; let c = 1 in let d = 2 in let x = C(capof(c),c) in let y = C(capof(d),d) in let z = C2(capof(x),x) in (z.o = y; z.o)";
  ...
  "sleep(0)";
  "class C {a : int}; class C2 {mut a : int}; let c1 = 0 in let x = C(capof(c1), c1) in let c2 = x.a in let y = C2(capof(c2), c2) in y";
  "class C {a : int}; class C2 {mut a : int}; let c1 = 0 in let x = C(capof(c1), c1) in let c2 = x.a in let y = C2(capof(c2), c2) in x"
]
...
let eval_failure = [
  ...
  "class C {mut a : int}; let c = 1 in let x = C(capof(c), c) in destroy(x.a); let y = x.a in y";
  "class C {mut a : int}; let c = 1 in let x = C(capof(c), c) in destroy(x.a); let y = x in y";
  "class C {mut a : int}; let c = 1 in let x = C(capof(c), c) in destroy(x); let y = x.a in y";
  "class C {mut a : int}; let c = 1 in let x = C(capof(c), c) in destroy(x); let y = x in y";
  ...
  "class C {mut a : int}; let c = true in let x = C(capof(c), c) in x";
  "class C {mut a : int}; let c1 = 0 in let c2 = true in let x = C(capof(c1), c1) in x.a = c2; x";
  (* mutable object assignment consumes cap *)
  "class C {mut a : int}; let c = 1 in let x = C(capof(c),c) in let y = x in (x.a = 0; y.a)";
  "class C {mut a : int}; let c = 1 in let x = C(capof(c),c) in let y = x in (x.a = 0; x.a)";
  "class C {mut a : int}; let c = 1 in let x = C(capof(c),c) in let y = x in (y.a = 0; x.a)";
  (* recursion SO *)
  "class C { mut w : (x : c0 C |)->unit }; let f = fun (x : c0 C |)->unit { x.w(x) } in let x = C(capof(f), f) in focus x { x.w(x) }";
]
